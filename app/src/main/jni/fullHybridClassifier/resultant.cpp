...
Java_com_mahmoodms_bluetooth_exgsinglechannel_DeviceControlActivity_jniMean(JNIEnv *env, jobject jobject1, jdoubleArray data, jint len) {
    jdouble  *dataArray;
...
//Call this function with (data, data, data, data, datalen, Fs);
//Don't need array size; can check size array in C.
Java_com_mahmoodms_bluetooth_exgsinglechannel_DeviceControlActivity_jniResultantAcc(JNIEnv *env, jobject jobject1, jdoubleArray data) {
    jdouble  *dataArray;
    dataArray = env->GetDoubleArrayElements(data, NULL);
    if(dataArray==NULL) LOGE("Error!");
...
//Call this function with (data, data, data, data, datalen, Fs);
//Don't need array size; can check size array in C.
Java_com_mahmoodms_bluetooth_exgsinglechannel_DeviceControlActivity_jniResultantGyro(JNIEnv *env, jobject jobject1, jdoubleArray data) {
    jdouble  *dataArray;
    dataArray = env->GetDoubleArrayElements(data, NULL);
