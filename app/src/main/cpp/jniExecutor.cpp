...
Java_com_yeolabgt_mahmoodms_ecg1chdemo_DeviceControlActivity_jecgBandStopFilter(
...
extern "C" {
JNIEXPORT jdoubleArray JNICALL
Java_com_yeolabgt_mahmoodms_ecg1chdemo_DeviceControlActivity_jdownSample(
...
Java_com_yeolabgt_mahmoodms_ecg1chdemo_DeviceControlActivity_jSSVEPCfilter(
        JNIEnv *env, jobject jobject1, jdoubleArray data) {
    jdouble *X1 = env->GetDoubleArrayElements(data, NULL);
 ...
 */
Java_com_yeolabgt_mahmoodms_ecg1chdemo_DeviceControlActivity_jLoadfPSD(
...
Java_com_yeolabgt_mahmoodms_ecg1chdemo_DeviceControlActivity_jmainInitialization(
