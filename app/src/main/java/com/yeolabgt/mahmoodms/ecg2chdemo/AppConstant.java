...
public final class AppConstant {
     ...
     */
    //Service:
    static final UUID SERVICE_MPU = UUID.fromString("228ba3a0-35fd-875f-39fe-b2a394d28057");
    //Characteristics:
    static final UUID CHAR_MPU_COMBINED = UUID.fromString("0000a3a5-0000-1000-8000-00805f9b34fb");
